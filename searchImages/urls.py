"""searchImages URL Configuration
...
from authentication.forms import LoginForm, MyPasswordResetForm, MySetPasswordForm, MyPasswordChangeForm
from searchImages import settings
